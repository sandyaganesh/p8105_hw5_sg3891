...
write function to iterate across each file name and use read csv to import each file = column of
data sets.

unnest the column to get files and each week as a colun

tidy the result (take the file name; get control arm and subject arm and unique subject ID; 
